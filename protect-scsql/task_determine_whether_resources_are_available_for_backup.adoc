...
+
Fare clic su image:../media/filter_icon.png[""] e selezionare il nome host e l'istanza SQL Server per filtrare le risorse. È quindi possibile fare clic su image:../media/filter_icon.png[""] per chiudere il riquadro del filtro.
