...
SnapCenter supporta la gestione delle relazioni SnapMirror flessibili in base alla versione. Per dettagli sulle relazioni SnapMirror flessibili in base alla versione e su come configurarle, consulta link:http://docs.netapp.com/ontap-9/index.jsp?topic=%2Fcom.netapp.doc.ic-base%2Fresources%2Fhome.html["Documentazione ONTAP"^].
