...
Installare una o più licenze SnapCenter. Per informazioni su come aggiungere le licenze, vedere link:../install/concept_snapcenter_standard_controller_based_licenses.html["Aggiunta di licenze SnapCenter basate su controller standard"] o link:../install/concept_snapcenter_standard_capacity_based_licenses.html["Aggiunta di licenze SnapCenter basate sulla capacità standard"].
