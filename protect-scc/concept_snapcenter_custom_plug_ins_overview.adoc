...
NetApp offre inoltre MySQL, MAXDB, DB2, SYBASE, DPGLUE, Plug-in personalizzati MongoDB, ORASCPM e PostgreSQL. Questi plug-in possono essere scaricati dal https://automationstore.netapp.com/home.shtml["Storage Automation Store di NetApp"^].
