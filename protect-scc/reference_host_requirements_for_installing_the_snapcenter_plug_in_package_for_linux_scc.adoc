...
|===
Per informazioni aggiornate sulle versioni supportate, consultare la https://imt.netapp.com/matrix/imt.jsp?components=117018;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"]
