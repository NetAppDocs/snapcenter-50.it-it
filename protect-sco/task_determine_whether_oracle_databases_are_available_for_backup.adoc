...
+
Fare clic su image:../media/filter_icon.png[""], quindi selezionare il nome host e il tipo di database per filtrare le risorse. È quindi possibile fare clic sull' image:../media/filter_icon.png[""] icona per chiudere il riquadro dei filtri.
