...
. Fare clic image:../media/more_icon.gif[""] sull'icona e fare clic su *Avvia servizio* o *Riavvia servizio*.
+
...
. Fare clic sull' image:../media/more_icon.gif[""] icona, quindi fare clic su *Sospendi pianificazione* per impostare l'host per il plug-in in modalità di manutenzione.
+
