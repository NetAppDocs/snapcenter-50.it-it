...
+
.. Fare clic image:../media/filter_icon.png[""] per filtrare l'elenco in modo che vengano elencate solo le operazioni di backup.
...
. Fare clic image:../media/activity_pane_icon.gif[""] sul riquadro attività per visualizzare le cinque operazioni più recenti.
+
