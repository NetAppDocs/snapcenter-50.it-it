...
+
Per ulteriori informazioni sui cmdlet di Windows, vedere https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmllllll["Guida di riferimento al cmdlet del software SnapCenter"^].
...
Gli esempi di plug-in personalizzati MySQL, DB2 e MongoDB per il software SnapCenter possono essere scaricati dal https://automationstore.netapp.com/home.shtml["Storage Automation Store di NetApp"^].
